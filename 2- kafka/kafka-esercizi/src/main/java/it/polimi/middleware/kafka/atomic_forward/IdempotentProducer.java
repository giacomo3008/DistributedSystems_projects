...
/*
  Con l'idempotenza attivata, anche se il producer invia
  lo stesso messaggio più volte (a causa di crash, retry,
  timeout o altri errori di rete), Kafka garantisce che
  quel messaggio venga scritto nel topic una sola volta.

  In pratica, Kafka rileva i duplicati e li scarta,
  evitando inserimenti multipli dello stesso record.
*/
